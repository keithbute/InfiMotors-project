...
<title>InfiMotors Care Sale</title>
<!--Bootstrap -->
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <p>Helping you SELL or BUY a vehicle without any hassles. We have the most affordable range of vehicle brands</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>WALK IN AND ></span> DRIVE OUT</h2>
      <p></p>
    </div>
    <div class="row"> 
